							...
							<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
								<ul class="top_bar_contact_list">
									...
									<li>
										...
										<div>+221- 77 014 29 62</div>
									</li>
									<li>
										<i class="fa fa-envelope-o" aria-hidden="true"></i>
										<div>kinzofamily@gmail.com</div>
									</li>
								</ul>
	...
	<div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
		...
		<nav class="menu_nav">
			<ul class="menu_mm">
				...
				<li class="menu_mm"><a href="#">Cours</a></li>
						...
						<div class="container">
							<div class="row">
								<div class="col text-center">
									<div class="home_slider_title">La Première Systéme Education</div>
									<div class="home_slider_subtitle">L'avenir de la technologie et de l'education</div>
